...
interface RatingsProps extends React.HTMLAttributes<HTMLDivElement> {
    ...
    Icon?: React.ReactElement<{ size?: number, className?: string, onClick?: any, onMouseEnter?: any, "data-star-index"?:any }> // Updated type
...
export const CommentRatings = ({
    ...
    return (
        <div
            ...
            onMouseLeave={isDisplayOnly ? undefined : handleMouseLeave}
            {...props}
        >
            <div className="flex items-center" onMouseEnter={isDisplayOnly ? undefined : handleMouseEnter}>
                {
...
interface PartialStarProps {
    ...
    size: number
    className?: string
    Icon: React.ReactElement<{ size?: number, className?: string }> // Updated type
}
