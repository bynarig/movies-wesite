...
export function VideoLayout({thumbnails, title, isVisible}: VideoLayoutProps) {
    return (
        <>
            {
                !isVisible ? null : (<>
                        ...
                        />
                        <Controls.Root
                            className={`${styles.controls} absolute inset-0 z-10 flex h-full w-full flex-col bg-gradient-to-t from-black/10 to-transparent opacity-100 transition-opacity`}
                        >
